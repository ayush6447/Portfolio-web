...
// Theme-matched color palettes
const DARK_COLORS  = ['#7c3aed', '#a855f7', '#c084fc', '#6366f1', '#818cf8', '#e879f9'];
const LIGHT_COLORS = ['#7c3aed', '#8b5cf6', '#a78bfa', '#6366f1', '#c084fc', '#d946ef'];
...
const Particles = ({
    ...
    useEffect(() => {
        ...
        const update = t => {
            ...
            if (!disableRotation) {
                mesh.rotation.x = Math.sin(elapsed * 0.00015) * 0.12;
                mesh.rotation.y = Math.cos(elapsed * 0.00025) * 0.18;
                mesh.rotation.z += 0.008 * speed;
            }
    ...
    }, [isDark, particleCount, particleSpread, speed, moveParticlesOnHover,
