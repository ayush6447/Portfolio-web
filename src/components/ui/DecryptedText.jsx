...
export default function DecryptedText({
  ...
  const triggerReverse = useCallback(() => {
    if (sequential) {
      ...
      pointerRef.current = 0; setRevealedIndices(fillAllIndices());
      ...
      setRevealedIndices(prevRevealed => {
        if (sequential) {
          if (direction === 'forward') {
            ...
            } else { clearInterval(intervalRef.current); setIsAnimating(false); setIsDecrypted(true); return prevRevealed; }
          }
          if (direction === 'reverse') {
            if (pointerRef.current < orderRef.current.length) {
              ...
              return newRevealed;
            } else { clearInterval(intervalRef.current); setIsAnimating(false); setIsDecrypted(false); return prevRevealed; }
          }
        } else {
          if (direction === 'forward') {
